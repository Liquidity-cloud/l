                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  ...
                  <div>
                    ...
                    <div className="flex gap-3">
                      {data.facebook && (
                        <a href={data.facebook} className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center transition-colors" style={{ ':hover': { backgroundColor: data.accentColor } }}>
