    ...
    <AdminLayout title="Нээлттэй бонд">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-6">
          {/* Language Toggle + Unsaved Changes */}
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                <Input
                  ...
                  placeholder={editLang === 'mn' ? 'Жишээ: Нээлттэй бонд' : 'e.g., Open Bond'}
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                <Input
                  ...
                  placeholder={editLang === 'mn' ? 'Жишээ: 8% - 12% per annum' : 'e.g., 8% - 12% per annum'}
                ...
                <Input
                  ...
                  placeholder={editLang === 'mn' ? 'Жишээ: 7-14 хоног' : 'e.g., 7-14 business days'}
                ...
                <Input
                  ...
                  placeholder={editLang === 'mn' ? 'Жишээ: 1-5 жил' : 'e.g., 1-5 years'}
